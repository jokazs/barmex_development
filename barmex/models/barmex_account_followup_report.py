...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_columns_name(self, options):
        ...
        headers = [{},
                   ...
                   {'name': 'Orden de compra', 'style': 'text-align:right; white-space:nowrap;'},
    ...
    def _get_lines(self, options, line_id=None):
        ...
        for currency, aml_recs in res.items():
            ...
            for aml in aml_recs:
                ...
                if is_payment:
                    date_due = ''
                move_line_name = self._format_aml_name('', aml.move_id.ref, aml.move_id.name) #Quita la factura de origen
                #move_line_name = self._format_aml_name(aml.name, aml.move_id.ref, aml.move_id.name) #Quita la factura de origen
